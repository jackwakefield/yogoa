...
func (x NodeClonedFunc) PassRef() (ref *C.YGNodeClonedFunc, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if nodeClonedFuncEB86E6D6Func == nil {
		nodeClonedFuncEB86E6D6Func = x
	}
	return (*C.YGNodeClonedFunc)(C.YGNodeClonedFunc_eb86e6d6), nil
}

func (x NodeClonedFunc) PassValue() (ref C.YGNodeClonedFunc, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	if nodeClonedFuncEB86E6D6Func == nil {
...
func NewNodeClonedFuncRef(ref unsafe.Pointer) *NodeClonedFunc {
	return (*NodeClonedFunc)(ref)
}

//export nodeClonedFuncEB86E6D6
func nodeClonedFuncEB86E6D6(coldNode C.YGNodeRef, cnewNode C.YGNodeRef, cparent C.YGNodeRef, cchildIndex C.int) {
	if nodeClonedFuncEB86E6D6Func != nil {
		oldNodeeb86e6d6 := *(*NodeRef)(unsafe.Pointer(&coldNode))
		newNodeeb86e6d6 := *(*NodeRef)(unsafe.Pointer(&cnewNode))
		parenteb86e6d6 := *(*NodeRef)(unsafe.Pointer(&cparent))
		childIndexeb86e6d6 := (int32)(cchildIndex)
		nodeClonedFuncEB86E6D6Func(oldNodeeb86e6d6, newNodeeb86e6d6, parenteb86e6d6, childIndexeb86e6d6)
		return
	}
	panic("callback func has not been set (race?)")
}

var nodeClonedFuncEB86E6D6Func NodeClonedFunc
